...
public class CodeGenerator {
    ...
    public static void main(String args[]) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/blog_1?useSSL=false&useUnicode=true&characterEncoding=utf8" +
                "&serverTimezone=Asia/Shanghai");
        dsc.setDriverName("com.mysql.cj.jdbc.Driver");
        dsc.setUsername("root");
        dsc.setPassword("garbohsing");
        dsc.setDbType(DbType.MYSQL);
        mpg.setDataSource(dsc);
        // 包的配置
        PackageConfig pc = new PackageConfig();
        pc.setModuleName(null);  // 设置包名下的模板名
        pc.setParent("com.garbo");
        ...
        */
        ...
        strategy.setTablePrefix("b_");                  // 表名前缀
